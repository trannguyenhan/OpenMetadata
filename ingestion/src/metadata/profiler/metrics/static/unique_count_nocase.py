...
from sqlalchemy import NVARCHAR, TEXT, column, func, literal_column,collate
...
class UniqueCountNoCase(QueryMetric):
    """
    UNIQUE_COUNT Metric
    ...
    def query(
        ...
        only_once = (
            ...
            .select_from(sample)
            .group_by(func.lower(group_by_col))

...
from metadata.data_quality.validations.column.base.BaseR42ColumnValuesOnlyInSet import (
    BaseR42ColumnValuesOnlyInSetValidator,
)
...
class R42ColumnValuesOnlyInSetValidator(
    BaseR42ColumnValuesOnlyInSetValidator, SQAValidatorMixin
):
    """Validator for column value to be in set test case"""

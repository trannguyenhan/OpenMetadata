...
from metadata.data_quality.validations.column.base.BaseR26ColumnValuesToBeUniqueNoCase import (
    BaseR26ColumnValuesToBeUniqueNoCaseValidator,
)
...
class R26ColumnValuesToBeUniqueNoCaseValidator(
    BaseR26ColumnValuesToBeUniqueNoCaseValidator, SQAValidatorMixin
):
    """Validator for column values to be unique test case"""
    ...
    def _get_unique_count(self, metric: ExtendMetrics, column: Column) -> Optional[int]:

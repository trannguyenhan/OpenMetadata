...
ALLOWED_VALUE_COUNT = "notAllowedValueCount"


class BaseR42ColumnValuesOnlyInSetValidator(BaseTestValidator):
    """Validator for column value to be in set test case"""
    ...
    def run_validation(self) -> TestCaseResult:
        ...
        try:
            ...
            res = self._run_results(ExtendMetrics.COUNT_NOT_IN_SET, column, values=allowed_values)

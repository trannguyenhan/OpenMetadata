...
from metadata.data_quality.validations.table.base.BaseR32FirstColumnInSetAndSecondColumnNotMatch import (
    BaseR32FirstColumnInSetAndSecondColumnNotMatchValidator,
)

logger = test_suite_logger()


class R32FirstColumnInSetAndSecondColumnNotMatchValidator(
    BaseR32FirstColumnInSetAndSecondColumnNotMatchValidator
):
    ...
    def _run_results(self, first_column_name: str, second_column_name: str,
        ...
        Args:
            ...
            test_fist_column_values (str): range interval
            test_second_column_regex (str): range interval
        """

        fist_column_test = test_fist_column_values.split('|')
        ...
        filter_ = and_(first_column.in_(fist_column_test), not_(second_column.regexp_match(test_second_column_regex)))

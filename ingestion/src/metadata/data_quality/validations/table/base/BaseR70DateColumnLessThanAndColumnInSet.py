...
ROW_COUNT = "Number of Rows code R70 ="


class BaseR70DateColumnLessThanAndColumnInSetValidator(BaseTestValidator):
    ...
    def run_validation(self) -> TestCaseResult:
        ...
        Returns:
            TestCaseResult:
        """
        date_column_name = self._get_date_column_name()
        ...
        try:
            date_column_name = cast(str, date_column_name)
            ...
            logger.warning(f'self._run_results({date_column_name}, {second_column_name}, {num_of_year},{values_test_column})')
            res = self._run_results(date_column_name, second_column_name, num_of_year,values_test_column)
    ...
    @abstractmethod
    def _run_results(self, date_column_name: str, second_column_name: str, range_interval: int,
